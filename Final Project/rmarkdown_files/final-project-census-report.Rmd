---
title: "Does Family Size Affect Mobility?"
subtitle: "STAT 7350 - Final Project"
author: "Scott White"
date: "April 19, 2019"
output: pdf_document
header-includes:
...
Judging by the figure below, we can see that there does not appear to be a significant difference between the years 2001 and 2006. This is fairly interesting because it shows there is a consistency in the ratio between the two years independent of the magnitude of the neighbourhoods in question. Often in an analysis there is a greater variance for larger quantities and less so for smaller quantities, but that does not appear to be the case for the total number of families in the different neighbourhoods within Winnipeg. The second plot within Figure \ref{fig:fig1} shows that there is clustering around the line with slope 1, indicating a near 1:1 ratio between the two census years. The Pearson correlation coefficient estimated a linear correlation of 99.2% between the two years.
